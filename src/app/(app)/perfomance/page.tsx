...
function SeletorConta({ contas, atual, mes }: { contas: { id: string; numero: string; tipo_conta: string }[]; atual: string; mes: string }) {
  return (
...
function SeletorMes({ mes, contaId }: { mes: string; contaId: string }) {
  return (
    <form action="/perfomance" className="flex">
